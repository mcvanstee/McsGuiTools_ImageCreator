...
{
    public static class StringToBitmapAnalyser
    {
        public static void GenerateTestImage(Font font,
            ...
            string path)
        {
            ...
            string filePath = FileUtils.CreateUniqeFileName(path, "TestString", ".png");
            ...
            int width, int height, int leftMargin, int topMargin, int rightMargin, int bottomMargin)
        {
            ...
            graphics.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixelGridFit;// AntiAlias;
